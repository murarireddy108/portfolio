...
import movieapp1 from "../projects images/movie-app(1).png";
import movieapp2 from "../projects images/movie-app(2).png";
import movieapp3 from "../projects images/movie-app(3).png";
import movieapp4 from "../projects images/movie-app(4).png";
import movieapp5 from "../projects images/movie-app(5).png";
import movieapp6 from "../projects images/movie-app(6).png";
    ...
    <div className="container card py-3 lead" id="pf">
      <div class="align-self-center">
        <div class="card-body ">
          ...
          <div className="card-header m-2">movie-app</div>
            <Carousel
              url1={movieapp1}
              url2={movieapp2}
              url3={movieapp3}
            ...
            <div>
              <p>
                ...
                YouTube , In this app we can add the movie and also we can delete
                we can edit the title of the movie and In this app we can play 
                tic tac toe game 
              </p>
              <span style={{ display: "flex", justifyContent: "space-evenly" }}>
                <a
                  ...
                  rel="noreferrer"
                  class="btn btn-secondary but"
                  href="https://github.com/murarireddy108/react-myapp"
                >
                  Source Code
                </a>
                <a
                  ...
                  rel="noreferrer"
                  class="btn btn-secondary but"
                  href="https://serene-newton-d69c62.netlify.app"
                >
                  Live Demo
                </a>
              </span>
